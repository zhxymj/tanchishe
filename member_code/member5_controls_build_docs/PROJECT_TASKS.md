...
| 成员4 | UI 绘制和视觉表现 | `src/ui.c`, `src/ui.h` | 背景、棋盘、网格、蛇身、蛇头眼睛、右侧面板、开始菜单、暂停和结束弹窗绘制。 |
| 成员5 | 控件交互、构建和文档 | `src/controls.c`, `src/controls.h`, `build.bat`, `CMakeLists.txt`, `README.md`, `CONTRIBUTING.md`, `TASKS.md` | 菜单按钮、鼠标点击、hover/pressed 状态、交互状态更新、编译脚本和文档同步。 |
